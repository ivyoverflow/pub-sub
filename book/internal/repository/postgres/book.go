...
func (repo *BookRepository) Insert(ctx context.Context, book *model.Book) (*model.Book, error) {
	...
	row := tx.QueryRowContext(ctx, query, book.ID, book.Name, book.DateOfIssue, book.Author, book.Description, book.Rating, book.Price, book.InStock)
...
func (repo *BookRepository) Update(ctx context.Context, bookID string, book *model.Book) (*model.Book, error) {
	...
	row := tx.QueryRowContext(ctx, query, book.Name, book.DateOfIssue, book.Author, book.Description, book.Rating, book.Price, book.InStock, bookID)
